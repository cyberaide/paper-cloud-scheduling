...
\input{image/graph-layer}

\input{image/graph-flow.tex}
...
\input{table/table-dynamic-placement}
...
\bibliography{bib/strings,bib/cloud-scheduling,bib/vonlaszewski}
