...
\RESOLUTION{I do not think the update of the workflow was completed by us.}

\OK{References related workflow in Cloud, containers, and FaaS are included.}
...
\RESOLUTION{Lifecycle policies move data after not being used to a less expensive tier.}
