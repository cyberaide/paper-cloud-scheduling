...
\RESOLUTION{We experimented with tables to place definitions in it but found it did not increase readability. of the paper as the table would have been over multiple pages. Hence we left the definitions in the main text. If however this were to be an issue that would prevent publication, we certainly can provide a table instead.}
...
\RESOLUTION{After many discussions, we still believe this section including Bare metal provisioning, HPC in the cloud and even Hadoop is worthwhile to be integrated into the paper to showcase the depth of the scheduling problems in the cloud. Yes, we have done research in these areas which precisely motivated us to include this section. We clarified that this section is important.}
