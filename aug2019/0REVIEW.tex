...
\RESOLUTION{TBD}
\OK{Point raised in the above comment is resolved}
...
\OK{In sections 2 and 3, we have mentioned the basic terminology and proposed taxanomy. Section 4 presents the literature survey of cloud scheduling algorithms and comparison tables are also presented. One column Taxanomy classification is included in the table to justify the proposed taxanomy.}
