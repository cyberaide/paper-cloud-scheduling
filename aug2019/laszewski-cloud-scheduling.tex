...
layer is still important to reduce complexity exposed to the users,
but if enough information between the layers is exchanged, this
information can lead to good scheduling decisions on each of the
layers.

When put together, we distinguish several classifications that
comprise Cloud scheduling into a scheduling taxonomy. This includes
