...
\item [Resource Provisioning in the Cloud:] The allocation of the
  resources demanded by services and applications. 
  
\item [Resource Scheduling in the Cloud:] Resource scheduling in the
  cloud refers to the mapping of resources to fulfill the cloud service
  requirements.
...
\item[Task, Job, Application, Service, Function scheduling] is the process
  to allocate resources to particular scheduling unit so they can be
