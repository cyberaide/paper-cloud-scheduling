...
\begin{abstract}
  ...
  a Service frameworks. It justifies

\color{red}

our proposed resource provider focused Y-cloud taxonomy and provides a
an overview of existing scheduling techniques in cloud computing.
...
is conducted on scales and pools of resources that were previously not
...
\item We outline specific characteristics of we face in cloud computing
  that identify its scheduling challenges.
